...
namespace CoreWf.Statements
{
    ...
    public sealed class TransactionScope : NativeActivity
    {
        ...
        protected override void Execute(NativeActivityContext context)
        {
            ...
            CoreWf.Runtime.Fx.Assert(transactionHandle != null, "RuntimeTransactionHandle is null");
            ...
            else
            {
                ...
                {
                    throw CoreWf.Internals.FxTrace.Exception.AsError(new InvalidOperationException(SR.AbortInstanceOnTransactionFailureDoesNotMatch));
                }

                if (foundHandle.SuppressTransaction)
                {
                    throw CoreWf.Internals.FxTrace.Exception.AsError(new InvalidOperationException(SR.CannotNestTransactionScopeWhenAmbientHandleIsSuppressed(this.DisplayName)));
                }
            ...
            else
            {
                ...
                {
                    throw CoreWf.Internals.FxTrace.Exception.AsError(new InvalidOperationException(SR.IsolationLevelValidation));
                }
        ...
        {
            CoreWf.Runtime.Fx.Assert(context != null, "ActivityTransactionContext was null");
        ...
        void OnDelayCompletion(NativeActivityContext context, ActivityInstance instance)
        {
            if (instance.State == ActivityInstanceState.Closed)
            {
                ...
                CoreWf.Runtime.Fx.Assert(handle != null, "Internal error.. If we are here, there ought to be an ambient transaction handle");
        ...
        {
            CoreWf.Runtime.Fx.Assert(this.delayWasScheduled.Get(context), "Internal error..Delay should have been scheduled if we are here");
        ...
        class IsolationLevelValidator : CodeActivity<bool>
        {
            ...
            protected override bool Execute(CodeActivityContext context)
            {
                ...
                if (parent != null)
                {
                    ...
                    CoreWf.Runtime.Fx.Assert(transactionScope != null, "ParentActivity was not of expected type");
        ...
        class AbortInstanceFlagValidator : CodeActivity<bool>
        {
            ...
            protected override bool Execute(CodeActivityContext context)
            {
                ...
                if (parent != null)
                {
                    ...
                    CoreWf.Runtime.Fx.Assert(parentTransactionScope != null, "ParentActivity was not of expected type");

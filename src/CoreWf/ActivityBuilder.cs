...
namespace CoreWf
{
    ...
    public sealed class ActivityBuilder /*: IDebuggableWorkflowTree */ //EBW NULLED
    {
        ...
        class PropertyReferenceCollection : Collection<ActivityPropertyReference>
        {
            ...
            protected override void InsertItem(int index, ActivityPropertyReference item)
            {
                ...
                {
                    CoreWf.Runtime.Fx.Assert(this.singleItemIndex < 0, "How did we have an index if we were empty?");
    ...
    [ContentProperty("Implementation")]
    public sealed class ActivityBuilder<TResult> /*: IDebuggableWorkflowTree */ //EBW NULLED
    {
        KeyedCollection<string, DynamicActivityProperty> properties;
        Collection<Constraint> constraints;
        Collection<Attribute> attributes;

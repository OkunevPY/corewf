    ...
    class DynamicActivityTypeDescriptor : ICustomTypeDescriptor
    {
        ...
        public PropertyDescriptorCollection GetProperties(Attribute[] attributes)
        {
            ...
            foreach (DynamicActivityProperty property in Properties)
            {
                ...
                {
                    throw CoreWf.Internals.FxTrace.Exception.AsError(new ValidationException(SR.ActivityPropertyRequiresName(this.owner.DisplayName)));
                }
                if (property.Type == null)
                {
                    throw CoreWf.Internals.FxTrace.Exception.AsError(new ValidationException(SR.ActivityPropertyRequiresType(this.owner.DisplayName)));
                }
        ...
        class DynamicActivityPropertyDescriptor : PropertyDescriptor
        {
            ...
            public override object GetValue(object component)
            {
                ...
                {
                    throw CoreWf.Internals.FxTrace.Exception.AsError(new InvalidOperationException(SR.InvalidDynamicActivityProperty(this.Name)));
                }
            ...
            protected override void FillAttributes(IList attributeList)
            {
                ...
                {
                    throw CoreWf.Internals.FxTrace.Exception.ArgumentNull("attributeList");
                }
        ...
        class ActivityPropertyCollection : KeyedCollection<string, DynamicActivityProperty>
        {
            ...
            protected override void InsertItem(int index, DynamicActivityProperty item)
            {
                ...
                {
                    throw CoreWf.Internals.FxTrace.Exception.AsError(new ArgumentException(SR.DynamicActivityDuplicatePropertyDetected(item.Name), "item"));
                }

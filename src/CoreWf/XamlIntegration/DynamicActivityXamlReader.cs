...
namespace CoreWf.XamlIntegration
{
    ...
    class DynamicActivityXamlReader : XamlReader, IXamlLineInfo
    {
        ...
        public override bool Read()
        {
            ...
            {
                CoreWf.Runtime.Fx.Assert(object.ReferenceEquals(this.innerReader, this.nodeReader), "readers must match at this point");
                    ...
                    else
                    {
                        ...
                        if (this.depth == 2)
                        {
                            if (currentMember.DeclaringType == this.activityXamlType || currentMember.DeclaringType == this.baseActivityXamlType)
                            {
                                ...
                                if (member == null)
                                {
                                    throw CoreWf.Internals.FxTrace.Exception.AsError(CreateXamlException(SR.MemberNotSupportedByActivityXamlServices(currentMember.Name), this.innerReaderLineInfo));
                                }
        ...
        class BuilderStack
        {
            ...
            {
                CoreWf.Runtime.Fx.Assert(reader.Member.Name == "PropertyName", "Exepcted PropertyName member");
                string result = null;
        ...
        class BufferedPropertyList
        {
            ...
            public void BufferDefinitions(DynamicActivityXamlReader parent)
            {
                ...
                subReader.Read();
                CoreWf.Runtime.Fx.Assert(subReader.NodeType == XamlNodeType.StartMember && subReader.Member == XamlLanguage.Members,
            ...
            public void ProcessDefaultValue(string propertyName, XamlMember propertyValue, XamlReader reader, IXamlLineInfo lineInfo)
            {
                ...
                {
                    throw CoreWf.Internals.FxTrace.Exception.AsError(CreateXamlException(SR.InvalidProperty(propertyName), lineInfo));
                }
            ...
            class ActivityPropertyHolder
            {
                        ...
                        switch (reader.NodeType)
                        {
                            case XamlNodeType.StartMember:
                                ...
                                if (reader.Member.DeclaringType == XamlLanguage.Property)
                                {
                                    ...
                                    {
                                        throw CoreWf.Internals.FxTrace.Exception.AsError(CreateXamlException(SR.PropertyMemberNotSupportedByActivityXamlServices(mappedMember.Name), readerLineInfo));
                                    }
                            ...
                            case XamlNodeType.Value:
                                ...
                                else if (typeDepth == 1)
                                {
                                    ...
                                    if (xamlType == null)
                                    {
                                        throw CoreWf.Internals.FxTrace.Exception.AsError(CreateXamlException(SR.InvalidPropertyType(reader.Value as string, this.Name), readerLineInfo));
                                    }
                                    this.Type = xamlType;
                                }
                                break;
                ...
                public void ProcessDefaultValue(XamlMember propertyValue, XamlReader subReader, IXamlLineInfo lineInfo)
                {
                    ...
                    {
                        throw CoreWf.Internals.FxTrace.Exception.AsError(CreateXamlException(SR.InvalidXamlMember(subReader.Member.Name), lineInfo));
                    }

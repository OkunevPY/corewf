...
namespace CoreWf.XamlIntegration
{
    ...
    public static class ActivityXamlServices
    {
        ...
        public static Activity Load(Stream stream)
        {
            if (stream == null)
            {
                throw CoreWf.Internals.FxTrace.Exception.ArgumentNull("stream");
            }
        ...
        public static XamlReader CreateReader(XamlReader innerReader)
        {
            if (innerReader == null)
            {
                throw CoreWf.Internals.FxTrace.Exception.ArgumentNull("innerReader");
            }
        ...
        public static XamlReader CreateReader(XamlReader innerReader, XamlSchemaContext schemaContext)
        {
            ...
            {
                throw CoreWf.Internals.FxTrace.Exception.ArgumentNull("schemaContext");
            }
        ...
        public static XamlWriter CreateBuilderWriter(XamlWriter innerWriter)
        {
            if (innerWriter == null)
            {
                throw CoreWf.Internals.FxTrace.Exception.ArgumentNull("innerWriter");
            }
        ...
        public static Func<object> CreateFactory(XamlReader reader, Type resultType)
        {
            if (reader == null)
            {
                throw CoreWf.Internals.FxTrace.Exception.ArgumentNull("reader");
            }
            if (resultType == null)
            {
                throw CoreWf.Internals.FxTrace.Exception.ArgumentNull("resultType");
            }
        ...
        static bool RequiresCompilation(IDynamicActivity dynamicActivity, LocationReferenceEnvironment environment, out string language)
        {
            ...
            if (!((Activity)dynamicActivity).IsMetadataCached)
            {
                ...
                {
                    if (CoreWf.Runtime.Fx.IsFatal(e))
                    {
                        throw;
                    }
                    throw CoreWf.Internals.FxTrace.Exception.AsError(new InvalidOperationException(SR.CompiledExpressionsCacheMetadataException(dynamicActivity.Name, e.ToString())));
                }
            ...
            {
                throw CoreWf.Internals.FxTrace.Exception.AsError(new InvalidOperationException(SR.DynamicActivityMultipleExpressionLanguages(vistor.GetConflictingLanguages().AsCommaSeparatedValues())));
            }
        ...
        )
        {
            ...
            {
                throw CoreWf.Internals.FxTrace.Exception.AsError(new ArgumentNullException("componentType"));
            }

            if (componentInstance == null)
            {
                throw CoreWf.Internals.FxTrace.Exception.AsError(new ArgumentNullException("componentInstance"));
            }
            ...
            {
                throw CoreWf.Internals.FxTrace.Exception.AsError(new InvalidOperationException(SR.BeforeInitializeComponentXBTExtensionResourceNotFound));
            }
            ...
            {
                throw CoreWf.Internals.FxTrace.Exception.AsError(new InvalidOperationException(SR.XamlBuildTaskResourceNotFound(xamlResourceName)));
            }
